...
document.addEventListener("mousemove", updatem);
document.addEventListener("touchmove", updatem);

function togglelight(toggle) {
  if (toggle == "on") {
    document.documentElement.className = ""
    document.getElementById("lamb").style.color="yellow"
    document.getElementById("github").style.color="black"
    document.getElementById("youtube").style.color="red"
    document.getElementById("twitter").style.color="rgb(29, 202, 255)"
  }
  else{
    document.documentElement.className = "xx"
    document.getElementById("lamb").style.color="black"
    document.getElementById("github").style.color="black"
